        ...
        try:
            ...
            for currency in currencies:
                ...
                if abs(diff_1_min) >= rules[shift_type][group]["1_min"] and not self.redis_client.get(currency+"_1_min"):
                    ...
                    message = "{} {} => {} ({}) BNS: {} in 1 min {}".format(currency, str(last_3_min[currency]), str(current_price[currency]), str(curr_price_inr), str(bns_price), str(diff_3_min))
                    ...
                    message = "{} {} => {} ({}) BNS: {} in 1 min {}".format(currency, str(last_5_min[currency]), str(current_price[currency]), str(curr_price_inr), str(bns_price), str(diff_5_min))
                    ...
                    message = "{} {} => {} ({}) BNS: {} in 1 min {}".format(currency, str(last_10_min[currency]), str(current_price[currency]), str(curr_price_inr), str(bns_price), str(diff_10_min))
                    ...
                    message = "{} {} => {} ({}) BNS: {} in 1 min {}".format(currency, str(last_15_min[currency]), str(current_price[currency]), str(curr_price_inr), str(bns_price), str(diff_15_min))
                    ...
                    message = "{} {} => {} ({}) BNS: {} in 1 min {}".format(currency, str(last_30_min[currency]), str(current_price[currency]), str(curr_price_inr), str(bns_price), str(diff_30_min))
                    ...
                    message = "{} {} => {} ({}) BNS: {} in 1 min {}".format(currency, str(last_60_min[currency]), str(current_price[currency]), str(curr_price_inr), str(bns_price), str(diff_60_min))
                if message:
